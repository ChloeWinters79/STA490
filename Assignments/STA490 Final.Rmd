...
• The data set orignially loads in with half missing observations <BR>
<BR>
...
## Further Investigation of Student Satisfaction Findings

<font size = 6>

• We have created several logistic regression models for the survey data with student satisfaction (q17) as the binary response variable <BR>
<BR>
• Now, let's further investigate the statistical significance of certain variables <BR>
<BR>
...
• My research question for this project was does satisfaction significantly differ between students who began their education at the particular college and transfer students? <BR>
<BR>
...
• We will use q17 as our binary response variable (student satisfaction: yes or no) <BR>
<BR>
...
---
## Logisitic Regression Model Findings Continued

<font size = 6>

• We can see that the question regarding a student's transfer status, q2, was not statistically significant, p = 0.569. <BR>
<BR>
• This indicates that a student's transfer status is not statistically significant to their overall satisfaction <BR>
<BR>
• No signficant difference in satisfaction between transfer students and non-transfer students <BR>
<BR>
• q2 would not be used in either a reduced or a stepwise selection model <BR>
<BR>
...
• Whether or not a student is an international student, q23, was also not statistically significant, p = 0.228. <BR>
<BR>
• Gender was also not statistically significant, p =  0.909. <BR>
<BR>
...
• q19, a student's age group was statistically significant with a p-value of p = 0.036 <BR>
<BR>
• q 10.7 whether a student has skills with using computing and informational technology was statistically significant, p = 0.038 <BR>
<BR>
• q 6.2, the number of books which students read for their own enjoyment outside of class was statistically significant, p = 0.017. <BR>
<BR>
